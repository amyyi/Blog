...
// upload file
// app.post('/blog/desktop/strategy/upload', upload.any(), (req, res, next) => {
//   next();
// });
...
app.use('/blog/desktop/accounts', accounts);
app.use('/blog/desktop/auth', auth);
app.use('blog/desktop/profiles', profiles);
app.use('/blog/desktop/article', article);
